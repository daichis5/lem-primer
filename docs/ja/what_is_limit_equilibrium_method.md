...
本資料では，各LEMが静力学的不静定性をどのように処理するかを整理した．ただし，実際の解析では，すべり面の形状，すべり方向，離散化の仕方，探索範囲なども結果の意味を左右する．これらを力学的に解釈するには，[第3資料「極限平衡法を実際に使うとき」](./lem_in_practice_mechanical_perspective.md)へ進む．
